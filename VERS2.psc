Algoritmo notas_media
	...
	Definir i,j Como Real; // CONTADOR;Las veces que se repite tomar datos sobre los alumnos,para rellenar los vectores de datos asociados a los alumnos,sus nombres.
